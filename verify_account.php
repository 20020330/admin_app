                        ...
                        <div class="col-xl-4 col-lg-5 col-md-6 d-flex flex-column mx-auto">
                            <div class="card card-plain mt-8">
                                <div class="card-header pb-0 text-left bg-transparent">
                                    <h3 class="font-weight-bolder text-info text-gradient">Tài khoản đã được xác thực</h3>
                                </div>
                                <!-- <div class="card-body">
                                    <form role="form" id="form" method="post">
                                        ...
                                        <div class="text-center">
                                            <button type="submit" name="btn_submit" class="btn bg-gradient-info w-100 mt-4 mb-0">Sign in</button>
                                        </div>
                                    </form>
                                </div> -->
                            </div>
