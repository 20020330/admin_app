...
$result = $dbConn->query("SELECT ut.id, ut.name, ut.create_at, count(cm.author) as book_amount 
                            FROM author as ut left join comic as cm on ut.id = cm.author
                            GROUP BY ut.id");
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Authors</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Authors</h6>
                </nav>
                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Book Amount</th>
                            ...
                            <tbody>
                                ...
                                while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                                    ...
                                    echo "<td>
                                            <p class='text-xs font-weight-bold mb-0'>" . $row['book_amount'] . "</p>
                                          </td>";
                                    echo "<td class='align-middle'>
                                                <a href='author/update.php?author_id=" . $row['id'] . "'class='badge bg-gradient-info' role='button' aria-pressed='true' data-bs-toggle='tooltip' data-bs-placement='top' title='Detail Author' data-container='body' data-animation='true'>
                                                    <svg style='fill: #fff;' xmlns='http://www.w3.org/2000/svg' height='1em' viewBox='0 0 512 512'><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                        <path d='M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z' />
                                                    </svg>
                                                </a>
                                                <a onclick='handleDeleteItem(this)' data-id='" . $row["id"] . "' class='badge bg-gradient-danger' role='button' aria-pressed='true' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Delete Author' data-container='body' data-animation='true'>
...
<script>
    function handleDeleteItem(btn_delete_comic) {
        appAlertConfirm(() => {
            ...
            // console.log(id);
            fetchData("POST", `author/handlePost.php`, {
                type_handle: "delete",
                author_id: id
            }).then(data => {
                if (data.status === "success") {
                    appAlert("Xóa tác giả thành công!", "Huray!", "success")
                    setTimeout(() => {
                        location.reload()
                    }, 500)
                } else {
    ...
    function appAlertConfirm(whenAcceptCallback) {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                appAlert("Tác giả vẫn còn nguyên <3", "Hmmmm")
            }
        })
    }
</script>