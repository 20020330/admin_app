            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Insert Author</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Insert Author</h6>
                </nav>
                    ...
                    <div class="card px-5 py-3">
                        <form id="form_author">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="search" id="author_name" name="author_name">
                            </div>
                            <div class="form-group">
                                <label for="author_info" class="form-control-label">Author Info</label>
                                <textarea class="form-control" rows="3" id="author_info" name="author_info"></textarea>
                            </div>
                            <div class="form-group gap-3">
                                <button type="button" class="btn bg-gradient-primary mt-3 me-3" id="btn_submit" name="btn_submit">Add Author</button>
    ...
    function handleSubmitAuthor(authorName, authorInfo) {
        fetchData("POST", "handlePost.php", {
            ...
            if (data.status === "success") {
                appAlert("Thêm tác giả thành công!", "Huray!", "success")
                form.reset()
                setTimeout(() => {
                    Swal.close()
                }, 500)
