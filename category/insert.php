            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-dark active" aria-current="page">Insert Categories</li>
                    </ol>
                    <h6 class="font-weight-bolder mb-0">Insert Categories</h6>
                </nav>
                    ...
                    <div class="card px-5 py-3">
                        <form id="form_category" class="row justify-content md-center">
                            <div class="col-3 mt-3">
                                ...
                                <img id="preview_thumbnail" name="preview_thumbnail" class="img-fluid rounded" style="object-fit: cover;" />
                            ...
                            <div class="col-9">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="search" id="category_name" name="category_name">
                                </div>
                                <div class="form-group">
                                    <label for="category_info" class="form-control-label">Category Info</label>
                                    <input class="form-control" id="category_info" name="category_info" type="search" />
                                </div>
                                <div class="form-group">
                                    <label for="category_color" class="form-control-label">Category Color</label>
                                    <input class="form-control" id="category_color" name="category_color" type="color" />
                                </div>
                                <div class="form-group gap-3">
                                    <button type="button" class="btn bg-gradient-primary mt-3 me-3" id="btn_submit" name="btn_submit">Add Category</button>
...
<script type="module">
    ...
    fileInput.addEventListener("change", (e) => {
        if (fileInput.files && fileInput.files[0]) {
            ...
            form.preview_thumbnail.style.setProperty("opacity", "1")
    ...
    buttonSubmitCategory.addEventListener("click", (e) => {
        ...
        if (fileInput.files && fileInput.files[0] && categoryColor.length > 0 && categoryInfo.length > 0 && categoryName.length > 0) {
    ...
    function handleSubmitCategory(data) {
        fetchData("POST", "handlePost.php", {
            ...
            if (data.status === "success") {
                appAlert("Thêm loại thành công!", "Huray!", "success", true)
                form.reset()
