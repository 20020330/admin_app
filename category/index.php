                        ...
                        <table class="table align-items-center mb-0">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Display Color</th>
                                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder opacity-7 ps-2">Create At</th>
                            ...
                            <tbody>
                                <?php
                                    ...
                                    //       </td>";
                                    echo "<td>
                                            <img id='preview_thumbnail' src='" . $row['thumbnail'] . "' name='preview_thumbnail' class='ratio ratio-1x1 rounded' style='object-fit: cover; width: 50px !important' />
                                          </td>";
                                    echo "<td>
                                            <p class='text-xs font-weight-bold mb-0'>" . $row['TITLE'] . "</p>
                                          </td>";
                                    echo "<td>
                                            <p class='text-xs font-weight-bold mb-0'>" . $row['DISPLAY_COLOR'] . "</p>
                                          </td>";
                                    echo "<td>
                                            <p class='text-xs font-weight-bold mb-0'>" . $row['create_At'] . "</p>
                                          </td>";
                                    echo "<td class='align-middle'>
                                                <a href='category/update.php?category_id=" . $row['ID'] . "'class='badge bg-gradient-info' role='button' aria-pressed='true' data-bs-toggle='tooltip' data-bs-placement='top' title='Detail Category' data-container='body' data-animation='true'>
                                                    <svg style='fill: #fff;' xmlns='http://www.w3.org/2000/svg' height='1em' viewBox='0 0 512 512'><!--! Font Awesome Free 6.4.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                                                        <path d='M256 512A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336h24V272H216c-13.3 0-24-10.7-24-24s10.7-24 24-24h48c13.3 0 24 10.7 24 24v88h8c13.3 0 24 10.7 24 24s-10.7 24-24 24H216c-13.3 0-24-10.7-24-24s10.7-24 24-24zm40-208a32 32 0 1 1 0 64 32 32 0 1 1 0-64z' />
                                                    </svg>
                                                </a>
                                                <a onclick='handleDeleteItem(this)' data-id='" . $row["ID"] . "' class='badge bg-gradient-danger' role='button' aria-pressed='true' data-bs-toggle='tooltip' data-bs-placement='bottom' title='Delete Category' data-container='body' data-animation='true'>
...
<script>
    function handleDeleteItem(btn_delete_comic) {
        appAlertConfirm(() => {
            ...
            // console.log(id);
            fetchData("POST", `category/handlePost.php`, {
                type_handle: "delete",
                category_id: id
            }).then(data => {
                if (data.status === "success") {
                    appAlert("Xóa thể loại thành công!", "Huray!", "success")
                    setTimeout(() => {
                        location.reload()
                    }, 500)
                } else {
    ...
    function appAlertConfirm(whenAcceptCallback) {
        Swal.fire({
            title: 'Xác nhận',
            text: "Bạn có chắc chắn muốn xóa thể loại?",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                ...
                appAlert("Thể loại vẫn còn nguyên <3", "Hmmmm")
            }
        })
    }
</script>